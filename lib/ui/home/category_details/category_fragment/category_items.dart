...
class CategoryItems extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        .animate()
        .slideX(
          begin: isEven ? -0.8 : 0.8,
          end: 0,
          duration: 1500.ms,
          curve: Curves
              .fastEaseInToSlowEaseOut, // إذا كان زوجي ينزلق من اليسار، وإذا كان فردي ينزلق من اليمين end: 0, duration: 600.ms, curve: Curves.easeOut,
        )
        .blurXY(
          begin: isEven ? 10.0 : -10.0,
          end: 0.0,
          duration: 2000.ms,
